                            ...
                            <th class="px-6 py-3 text-center text-[10px] font-bold text-slate-400 uppercase">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <div class="tooltip-container">
                                        <svg class="w-3.5 h-3.5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
        ...
        <section class="bg-white rounded-xl border border-slate-200 shadow-sm" aria-label="相邻色块检测">
            <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 rounded-t-xl">
                <h2 class="font-bold text-slate-800 flex items-center gap-2">
                    ...
                    <div class="tooltip-container">
                        <svg class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                ...
                <div class="border {border_color} rounded-lg p-5 bg-white shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <div class="tooltip-container"><span class="px-2 py-0.5 rounded text-[10px] font-black cursor-help {tag_bg} {tag_text}">常规 ΔE {normal_de:.1f}</span></div>
                        </div>
                        {img_html}
...
if __name__ == '__main__':
    print("HTML Report Generator optimized with Grid Micro-Analysis and Lightbox.")